...
public class FlowFileTwoStepUnpackagerV2 implements FlowFileTwoStepUnpackager {
    ...
    @Override
    public Map<String, String> unpackageAttributes(final InputStream in) throws IOException {
    ...
    @Override
    public void unpackageContent(final InputStream in, final OutputStream out) throws IOException {
