...
public class NormalizeFlowPlan extends FlowPlan {
    private List<TransformActionConfiguration> transformActions;
    private LoadActionConfiguration loadAction;

    public NormalizeFlowPlan(String name, String description) {
        super(name, FlowType.NORMALIZE, description);
    }

    @PersistenceCreator
    @JsonCreator
    @SuppressWarnings("unused")
    public NormalizeFlowPlan(@JsonProperty(value = "name", required = true) String name,
