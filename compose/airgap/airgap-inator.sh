...
function create_distro() {
  ...
  cp -rf "$DELTAFI_PATH/migrations" "$AIRGAP_DISTRO_TREE"
  cp -rf "$DELTAFI_PATH/deltafi-cli" "$AIRGAP_DISTRO_TREE"
  ...
  cp -rf "$COMPOSE_PATH/settings" "$AIRGAP_DISTRO_TREE/compose"
