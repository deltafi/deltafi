...
@Component
public class SelectContent extends TransformAction<SelectContentParameters> {
    public SelectContent() {
        super(ActionOptions.builder()
                .description("Selects content to pass through, dropping unselected content.")
                ...
                .outputSpec(ActionOptions.OutputSpec.builder()
                        .contentSummary("Only content matching the selection criteria is retained.")
                        .build())
                .build());
    }

    @Override
    public TransformResultType transform(@NotNull ActionContext context, @NotNull SelectContentParameters params,
