...
@Component
public class RubberStampValidateAction extends ValidateAction<RoteParameters> {
    public RubberStampValidateAction() {
        super("Validate successfully every time");
    }

    public ValidateResultType validate(@NotNull ActionContext context, @NotNull RoteParameters params, @NotNull ValidateInput input) {
