<template>
    ...
    <DialogTemplate ref="addDataSource" component-name="dataSources/DataSourceConfigurationDialog" header="Add Data Source" dialog-width="50vw" :row-data-prop="{}" @reload-data-sources="refresh" />
    <FileUpload v-show="false" auto ref="dataSourceFileUploader" mode="basic" accept=".json,application/json" :file-limit="1" custom-upload @uploader="preUploadValidation" :pt="{
        input: {
