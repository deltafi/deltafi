...
<template>
  <CollapsiblePanel header="Actions" class="table-panel">
    <DataTable :value="props.actions" responsive-layout="scroll" striped-rows class="p-datatable-sm p-datatable-gridlines" data-key="name" sort-field="name" :sort-order="1">
