<template>
    ...
    <DialogTemplate ref="editDataSink" component-name="dataSinks/DataSinkConfigurationDialog" header="Edit Data Sink" dialog-width="50vw" :row-data-prop="data" edit-data-sink @reload-data-sinks="refresh" />
    <DialogTemplate ref="cloneDataSink" component-name="dataSinks/DataSinkConfigurationDialog" header="Create Data Sink" dialog-width="50vw" :row-data-prop="formatCloneDataSink(data)" @reload-data-sinks="refresh" />
</template>
