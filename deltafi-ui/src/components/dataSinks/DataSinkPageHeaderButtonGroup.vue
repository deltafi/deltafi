<template>
    ...
    <DialogTemplate ref="addDataSink" component-name="dataSinks/DataSinkConfigurationDialog" header="Add Data Sink" dialog-width="50vw" :row-data-prop="{}" @reload-data-sinks="refresh" />
    <FileUpload v-show="false" auto ref="dataSinksFileUploader" mode="basic" accept=".json,application/json" :file-limit="1" custom-upload @uploader="preUploadValidation" :pt="{
        input: {
