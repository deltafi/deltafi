...
const responseHandler = () => {
  ...
  if (import.meta.env.VITE_MOCK_RESPONSES === "successResponse") {
    worker = setupWorker(...successReponseHandlers);
  } else if (import.meta.env.VITE_MOCK_RESPONSES === "errorResponse") {
    worker = setupWorker(...errorResponseHandlers);
  } else if (import.meta.env.VITE_MOCK_RESPONSES === "customResponse") {
