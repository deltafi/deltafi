...
module Deltafi
  class ClickhouseETL
    ...
    def initialize(interval: 10.seconds, lag: 30.seconds, limit: 1000, delete_ttl: '14 DAY')
      ...
      @last_update = (@clickhouse.select_value("SELECT update_timestamp FROM #{DELTAFILE_TABLE_NAME} WHERE did NOT LIKE 'survey%' ORDER BY update_timestamp DESC LIMIT 1") || '1985-10-26 01:21:00'.to_datetime) - 1.second
