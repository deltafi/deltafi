...
public class DeltaFiConfigDataLoader implements ConfigDataLoader<DeltaFiConfigDataResource> {
    ...
    private final PropertyMetadataLoader propertyMetadataLoader = new PropertyMetadataLoader();
    ...
    public ConfigData load(ConfigDataLoaderContext context, DeltaFiConfigDataResource resource) throws IOException, ConfigDataResourceNotFoundException {
        ...
        Environment environment = deltaFiCompositeEnvironmentRepository.findOne(PropertyConstants.CORE_DOMAIN_APP_NAME, PropertyConstants.PROFILE, PropertyConstants.DEFAULT_LABEL);
