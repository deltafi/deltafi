...
public class DeltaFilesDatafetcherTestHelper {
    ...
    public static final IngressInput INGRESS_INPUT_EMPTY_METADATA = new IngressInput(DID, SOURCE_INFO_EMPTY_METADATA, CONTENT_REFERENCE, OffsetDateTime.now());
    public static final IngressInput INGRESS_INPUT = new IngressInput(DID, SOURCE_INFO, CONTENT_REFERENCE, OffsetDateTime.now());
    public static final IngressInput INGRESS_INPUT_2 = new IngressInput(DID_2, SOURCE_INFO, CONTENT_REFERENCE_2, OffsetDateTime.now());
