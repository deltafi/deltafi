...
public interface ActionRepoCustom {
     ...
     *
     * @param flows A set of {@code String} values representing the dataSource names for which to retrieve error counts.
     * @return A {@code Map<String, Integer>} where the key is the dataSource name and the value is the error count for that dataSource.
     */
