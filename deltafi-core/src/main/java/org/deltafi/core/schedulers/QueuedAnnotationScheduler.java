...
public class QueuedAnnotationScheduler {
    ...
    public void schedule() {
        taskScheduler.scheduleAtFixedRate(deltaFilesService::processQueuedAnnotations, Instant.now().plusSeconds(INITIAL_DELAY), Duration.ofSeconds(PERIOD));
    }
}
