...
import org.deltafi.core.plugin.generator.flows.IngressFlowPlanGenerator;
...
@SpringBootTest(classes = {JavaPluginGenerator.class, FlowPlanGeneratorService.class, IngressFlowPlanGenerator.class,
