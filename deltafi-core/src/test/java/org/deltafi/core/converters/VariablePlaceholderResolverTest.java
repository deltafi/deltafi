...
class VariablePlaceholderResolverTest {
    ...
    private static List<Arguments> testArgs() {
        ...
        Arguments.of(PLACEHOLDER, List.of(Variable.builder().name(PLACEHOLDER).value(null).defaultValue(null).required(true).dataType(VariableDataType.STRING).build()), null),
