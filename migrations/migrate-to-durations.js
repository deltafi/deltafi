db.deltaFiProperties.updateOne({"_id":"deltafi-properties"}, [{"$set":{"requeueDuration": { $concat: ["PT",{$toString:"$requeueSeconds"},"S"]}}}])
...
db.systemSnapshot.updateMany({}, [{"$set":{"deltaFiProperties.requeueDuration": { $concat: ["PT",{$toString:"$deltaFiProperties.requeueSeconds"},"S"]}}}])
...
db.deltaFiProperties.updateOne({"_id":"deltafi-properties"}, [{"$set":{"deltaFileCache.syncDuration": { $concat: ["PT",{$toString:"$deltaFileCache.syncSeconds"},"S"]}}}])
...
db.systemSnapshot.updateMany({}, [{"$set":{"deltaFiProperties.deltaFileCache.syncDuration": { $concat: ["PT",{$toString:"$deltaFiProperties.deltaFileCache.syncSeconds"},"S"]}}}])
